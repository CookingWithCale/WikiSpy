...
"""A list of Resource(s) controlled by an Organization.
"""
class ASListResource(CRNode):

  def __init__(self, Crabs, TypeID = 0, Type = 'List.Resource', 
