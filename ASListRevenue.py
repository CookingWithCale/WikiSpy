...
"""A list of ListRevenue(s).
"""
class ASListRevenue(CRNode):

  def __init__(self, Crabs, TypeID = 0, Type = 'ListRevenue', 
  ...
  def Print(self):
    print('\nRevenue Streams:')
    for Key, Value in self.ListRevenues.items():
      print('\nKey:"', Key, ' Value:"', Value)
