...
* [Software Design Document](../)
   * Proposed Software Architecture
      * [AccessControlAndSecurity](./AccessControlAndSecurity.md)
      * [Boundary Conditions](./BoundaryConditions.md)
      * [Global Software Control](./GlobalSoftwareControl.md)
      * [Hardware-to-Software Mappings](./HardwareToSoftwareMappings.md)
      * [Overview](./Overview.md)
      * [Persistent Data Management](./PersistentDataManagement.md)
      * [Subsystem Decomposition](./SubsystemDecomposition.md)
