...
The Implementation is required to be deployable on a low-cost web server for budget reasons, and on clusters of Nodes capable of training and simulating neural networks such as a standard desktop or rack-mount PC with GPU.
