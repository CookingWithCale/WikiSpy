...
The WikiSpy web display layer shall display pre-generated content with high performance for minimal web servers. The WikiSpy Node shall take long periods to train AI and Deep Learning models. WikiSpy shall take short periods of time to run the trained neural network on the Wiki. WikiSpy shall take long periods to iterate through the entire Wiki.
