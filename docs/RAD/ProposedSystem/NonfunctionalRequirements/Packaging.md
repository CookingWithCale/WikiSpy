...
WikiSpy shall be able to be distributed using a standard Container system as a downloadable executable installer that installs the WikiSpy node and a pre-built VM.
