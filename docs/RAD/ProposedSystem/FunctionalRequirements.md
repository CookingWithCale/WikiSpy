...
7. WikiSpy shall compare all Wikipedia-like websites.
8. WikiSpy shall be able to hand triple the current number of Wikipedia articles, in the English language, which is currently about 6,280,438.
