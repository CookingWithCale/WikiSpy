...
This section is split into two sections based on what is inside and outside of the scope of WikiSpy.

#### Inside of Scope

Inside of the Scope of the System is to be able to detect tampering, misinformation, political bias, criminal activity including detection of hostile actors, money and corporate influence, and similar criteria, and to use a social network and social networking site to crowd-source Wiki fact-checks and corrections.

#### Outside of Scope

Law Enforcement, doxing, bullying, and any unlawful activities are outside of the scope of the project.
