##### UseCaseFactCheckArticleFarRight
...
1. Star needs to check if a Wikipedia article "Far-right" has been tampered with.

***Flow of Events***

1. Star opens the ScreenFactCheckArticle and types "Far-right" into the WikiSpy search bar and presses ButtonSearch.
1. ***<<<*** WikiSpy checks if the article has been tampered with and loads the ScreenArticle.
1. Star types in "foo baby".
1. ***<<<*** WikiSpy responds with "Ooooo yeah baby!"
